...
const Team = ({team}) => {
	const {name, title, timestamp, color, member, creator} = team;
		...
		>
			...
			>
				...
				<div className="flex items-center">
					...
					<img
					className="w-5 h-5 text-gray-300 fill-current absolute bottom-0 right-0 mb-4 mr-3"
					src={`https://robohash.org/${creator.email}?size=200x200`}
					alt="team-img"
				/>
