...
const Modal = ({ open, control }) => {
	...
	const [addConversation, {isSuccess: isAddConversationSccess}] = useAddConversationMutation();
	...
	useEffect(() => {
		if(isAddConversationSccess || isEditConversationSuccess) {
			control();
		}
	}, [isAddConversationSccess, isEditConversationSuccess])
